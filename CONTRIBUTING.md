...
You may want to use the GitHub interface to fork [Beerus](https://github.com/myBraavos/beerus) and check out your fork.
...
For the versions available, see the [tags on this repository](https://github.com/myBraavos/beerus/tags).
...
Make sure all the [GitHub Actions](https://github.com/myBraavos/beerus/actions) checks pass.
